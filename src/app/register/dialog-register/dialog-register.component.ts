...
import { DialogLoginComponent } from 'src/app/login/dialog-login/dialog-login.component';
...
export class DialogRegisterComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) private url: string // private serviceDialogRegister : DialogService,
  ) {}
